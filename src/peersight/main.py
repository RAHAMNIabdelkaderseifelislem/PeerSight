...
def run():
    ...
    try:
        ...
        logger.info(f"Effective LLM Temperature: {effective_temperature} "
        ...
        if success:
            ...
            if success and output_content is not None:
                ...
                if args.output:
                    ...
                    if write_success:
                        print(f"Review successfully saved to: {args.output}", file=sys.stderr) # Print confirmation to stderr
